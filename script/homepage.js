...
document.onkeydown = function(e) {
	...
	if(k == 37) {
		try{if(Dd('baiyun_previous').value && typeof document.activeElement.name == 'undefined')Go(Dd('baiyun_previous').value);}catch(e){}
	} else if(k == 39) {
		try{if(Dd('baiyun_next').value && typeof document.activeElement.name == 'undefined')Go(Dd('baiyun_next').value);}catch(e){}
	}
}